...
//         .def("set_automation", &ProcessorBaseWrapper::setAutomation, arg("parameter_name"), arg("data"), R"pbdoc(
...
//         .def("get_parameter", &PluginProcessor::wrapperGetParameter, arg("index"), "Get a parameter's value.")
//         .def("get_parameter_name", &PluginProcessor::wrapperGetParameterName, arg("index"), "Get a parameter's name.")
//         .def("get_parameter_text", &PluginProcessor::getParameterAsText, arg("index"), "Get a parameter's value as text.")
//         .def("set_parameter", &PluginProcessor::wrapperSetParameter, arg("index"), arg("value"),
//             "Set a parameter's value to a constant.")
//         .def("set_automation", &PluginProcessor::wrapperSetAutomation, arg("parameter_index"), arg("data"),
...
Note that note-ons and note-offs are counted separately.")
    ...
    py::class_<RenderEngineWrapper>(m, "RenderEngine", "A Render Engine loads and runs a graph of audio processors.")
        ...
        .def("get_audio", &RenderEngineWrapper::getAudioFrames, "Get the most recently rendered audio as a numpy array.")
        .def("get_audio", &RenderEngineWrapper::getAudioFramesForName, arg("name"), "Get the most recently rendered audio for a specific processor.")
