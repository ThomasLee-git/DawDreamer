...
int main(int argc, char *argv[]) {
  ...
  const std::string preset_path =
      "/Users/thomas/bak/test_dawdreamer/charango.fxp";
  const std::string wav_path = "/Volumes/ramdisk/lxd_test_dawdreamer.wav";
